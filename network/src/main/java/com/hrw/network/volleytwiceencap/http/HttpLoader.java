...
import com.hrw.network.volleytwiceencap.http.httputils.Assert;
import com.hrw.network.volleytwiceencap.http.httputils.FileCopyUtils;
import com.hrw.network.volleytwiceencap.http.utils.ALog;
import com.hrw.network.volleytwiceencap.http.utils.MD5Utils;
...
public class HttpLoader {
    ...
    private Request<?> request(int method, String url, HttpParams params, Class<? extends IResponse> clazz, final int requestCode, final HttpListener listener, boolean isCache) {
        ...
        if (request == null) {
            ...
            if (method == Request.Method.GET && isCache && false) {
