 ...
 */
public class FadeInFadeOutActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.bt_show:
                startActivity(new Intent(MyApplication.context,FadeInFadeOutActivity2.class));
                break;
        }
    }
}
